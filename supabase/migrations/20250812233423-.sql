-- Remove the specific orphaned document field that's causing the constraint error
DELETE FROM document_fields WHERE document_id = 'ea032cca-c394-451f-88b0-c967619d12d8';
